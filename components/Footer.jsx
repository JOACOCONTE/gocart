...
const Footer = () => {
    ...
    return (
        <footer className="mx-6 bg-[#e1edfa]">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="relative">
                            <Image src={assets.logo_arte_joyas_footer} alt="GoCart Logo" height={50} width={150} priority />
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Bienvenido a Arte en Joyas, tu destino para joyería de autor y piezas únicas.
                        detalle.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2026 © Arte en Joyas | Ruben Badia - Todos los derechos recervados.
                </p>
            </div>
        </footer>
    );
